...
1) Τι είναι το project με μια πρόταση
...
2️) Τι συστήματα πρέπει να υλοποιήσεις
...
3️) Ποιες βασικές διαδικασίες (operations) ζητούνται
...
4️) Τι θεωρείται key και τι value
- Key
...
5️) Dataset – πώς χρησιμοποιείται
...
6️) Ειδικό ερώτημα που ζητείται (K-movies popularity)
...
7️) Τοπικά indexes (bonus αλλά σημαντικό)
...
8️) Τι μετρήσεις (experiments) πρέπει να κάνεις
